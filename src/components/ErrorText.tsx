  ...
  return (
    <div className='m-3 page'>
      ...
      <p>
        ...
        <span className='text-danger font-weight-bold'>Tell the user to press F5, Morty!</span> Yeah, just like that!
        Refresh the page, Morty! It’s like hitting the reset button on your existence, Morty!
      </p>
    </div>
  );
}
